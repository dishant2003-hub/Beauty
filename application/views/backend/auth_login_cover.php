...
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= BACKEND_ASSETS_PATH; ?>" data-template="vertical-menu-template">

  
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:39:24 GMT -->
<head>
    <meta charset="utf-8" />
...
<!-- <link rel="stylesheet" href="vendor/libs/formvalidation/dist/css/formValidation.min.css" /> -->
    ...
    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="<?= BACKEND_ASSETS_PATH; ?>vendor/css/pages/page-auth.css">
    <!-- Helpers -->
...
<body>
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
        <div class="flex-row text-center mx-auto">
          <img src="<?= BACKEND_ASSETS_PATH; ?>img/pages/login-light.png" alt="Auth Cover Bg color" width="520" class="img-fluid authentication-cover-img" data-app-light-img="pages/login-light.png" data-app-dark-img="pages/login-dark.png">
          <div class="mx-auto">
      ...
      <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
          ...
          <form id="formAuthentication" class="mb-3" action="<?= base_url('backend/home/process') ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
              <label for="email" class="form-label">Username</label>
              <input type="text" class="form-control" id="email" name="user" placeholder="Enter your username" required="">
            </div>
  ...
  <!-- Vendors JS -->
  <!-- <script src="<?= BACKEND_ASSETS_PATH; ?>vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
  <script src="<?= BACKEND_ASSETS_PATH; ?>vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
  <script src="<?= BACKEND_ASSETS_PATH; ?>vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script> -->

  <!-- Main JS -->
  <!-- <script src="<?= BACKEND_ASSETS_PATH; ?>js/main.js"></script> -->

  <!-- Page JS -->
  <!-- <script src="<?= BACKEND_ASSETS_PATH; ?>js/pages-auth.js"></script> -->
</body>


<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:39:25 GMT -->
