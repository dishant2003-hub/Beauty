                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6 ">
                                <div class="form-group">
                                    <h5>Full Name</h5>
                                    <div class="vegita"><?php echo $array['fname']; ?> <?php echo  $array['lname']; ?></div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    <h5>E-mail</h5>
                                    <div class="vegita"><?php echo $array['email']; ?> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6 ">
                                <div class="form-group">
                                    <h5>Dob</h5>
                                    <div class="vegita"><?php echo $array['dob']; ?> </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    <h5>Gender</h5>
                                    <div class="vegita"><?php echo $array['gender']; ?> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
